...
class m160220_013525_contentcontainer_id extends Migration
{
    ...
    public function up()
    {
        ...
        //Yii::$app->db->createCommand('UPDATE content SET content.created_by = NULL WHERE id IN (SELECT content.id FROM content LEFT JOIN user u ON content.created_by = u.id WHERE u.id IS NULL)')->execute();
